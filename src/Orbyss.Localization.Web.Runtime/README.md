...
The web feature depends on `Orbyss.Localization.Runtime`, which registers the default release-backed
resolver. Consumers select a storage feature and configure `Orbyss:Localization:Runtime:CatalogId`.
