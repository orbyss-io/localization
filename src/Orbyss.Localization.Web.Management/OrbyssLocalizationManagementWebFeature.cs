...
[ShellFeature(
    ...
    DependsOn = [typeof(global::Orbyss.Localization.OrbyssLocalizationManagementFeature)])]
public sealed class OrbyssLocalizationManagementWebFeature(ShellSettings settings) : IWebShellFeature
{
    /// <inheritdoc />
